<div class="mobile-menu">
    ...
    <ul class="mobile-menu__list">
        @foreach($mainMenu as $menuItem)
            <li class="mobile-menu__item">
                ...
                <a href="{{ data_get($menuItem, 'link') }}" class="mobile-menu__link">
    ...
    @auth
    <a href="{{ route('filament.pages.dashboard') }}" class="btn nav__personal-mobile__menu">
